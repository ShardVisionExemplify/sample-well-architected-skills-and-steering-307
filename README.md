...
```bash
git clone https://github.com/ShardVisionExemplify/sample-well-architected-skills-and-steering-307.git
cd sample-well-architected-skills-and-steering-307
python setup.py
```
...
<!-- Last updated: 2026-06-06 17:17:15 -->
